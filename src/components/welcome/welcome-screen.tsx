...
export function WelcomeScreen() {
  ...
  return (
    <View className="flex-1 bg-[#F8FAFC]">
      ...
      <ScrollView className="flex-1 px-6" contentContainerClassName="gap-4 pb-[140px] -mt-6">
      ...
      <View className="absolute bottom-0 left-0 right-0 bg-[#F8FAFC] pt-4 pb-6">
        <View className="gap-3 px-6">
          <Button text="Iniciar Sesión" variant="primary" className="rounded-full py-4 shadow-md" to="/login" />
          <Button text="Crear Cuenta" variant="primary" className="rounded-full py-4 shadow-md" to="/register" />
        </View>
      </View>
    </View>
  );
