...
11. ✅ **Gastos Consolidados (Grupo Personal Principal):** Implementado Cash Basis Accounting clonando gastos e inyectando reembolsos negativos en el grupo personal configurado como principal (`mainPersonalGroupId`).
