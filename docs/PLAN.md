...
9. **Soporte para Apodos (Nicknames):** Permitir a los usuarios configurar un alias o apodo para mostrarse en la interfaz o dentro de grupos específicos, en lugar de su nombre real o completo.10. ✅ **Sincronización Global de Estado (React Query):** Implementado `@tanstack/react-query` para garantizar que los datos (gastos, grupos, balances) se actualicen en tiempo real y se compartan entre todas las pestañas sin necesidad de recargar la aplicación.
